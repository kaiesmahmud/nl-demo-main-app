<script>
    ...
    let pName = p_name
    let pUrl = p_url
    let pPrice = parseInt(p_price)
    let pRegPrice = parseInt(p_reg_price)
    let pStock = parseInt(p_stock)
    let pImg = p_img
    let pType = p_type
...
<div class="py-5 px-2">
    <form on:submit={handleUpdateProductData}>
    ...
    <!-- ====================Product URL================= -->
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            ...
                            <input bind:value={pUrl} type="text" name="p_url" id="p_url"  class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" required placeholder="diamond-ring">
                            </div>
                        </div>
                    </div>
    ...
    <!-- =======================Price===================== -->
                    <div class="sm:col-span-2 sm:col-start-1">
                        ...
                        <div class="mt-2">
                        <input bind:value={pPrice} type="number" name="city" id="city" required  autocomplete="address-level2" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-2">
                        <input bind:value={pRegPrice} type="number" name="region" required id="region" autocomplete="address-level1" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-2">
                        <input bind:value={pStock} type="number" name="postal-code" id="postal-code" autocomplete="postal-code" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    </div>
                </div>
            ...
            <button on:click={handleShowUpdate} type="button" class="text-sm font-semibold leading-6 text-gray-900">Cancel</button>
            <button  type="submit" class="rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">Update</button>
            </div>
      </form>
</div>